...
def teste_incluir_pet():
    ...
    resultado_obtido = requests.post(
        url=url,
        headers=headers,
        data=open('C:\\Users\\Estudos\\Documents\\Python\\134inicial-master\\vendors\\json\\pet1.json')
    )
...
def teste_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=url,
        headers=headers,
        data=open('C:\\Users\\Estudos\\Documents\\Python\\134inicial-master\\vendors\\json\\pet2.json')
    )
...
@pytest.mark.parametrize(
    ...
    ler_csv('C:\\Users\\Estudos\\Documents\\Python\\134inicial-master\\vendors\\csv\\massa_incluir_pet.csv')
)
